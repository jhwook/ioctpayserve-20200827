...
router.post('/genericcall',(req,res)=>{const {datastr}=req.body
  const options={... optionscommon, body:datastr}
  const callback = (error, response, body) => { console.log(error);    if (!error && response.statusCode == 200) { respok(res,body,null);return false}
  }  
...
/*{  status: 'OK', message: '{"result":"","error":null,"id":"curltest"}\n',
  code: null
}*/
